...
\author{Darius-Andrei Moldovan, Tudor Moldovanu, Andrei Suciu}
...
\begin{enumerate}
	\item Darius-Andrei Moldovan
	    \begin{enumerate}
	     \item Threads: dealt with Fixed Priority Scheduler
	     \item Userprog: dealt with System Calls for Process Management and File System Access
	     \item VM: dealt with Per Process Quotas and Zero Pages
	    \end{enumerate}

	\item Tudor Moldovanu
	    \begin{enumerate}
	     \item Threads: dealt with Timer
	     \item Userprog: dealt with Argument Parsing and Validation of System Call Arguments
	     \item VM: dealt with Syscalls and Stack Growth
	    \end{enumerate}
	    
	\item Andrei Suciu
	    \begin{enumerate}
	     \item Threads: dealt with Priority Donation
	     \item Userprog: dealt with System Calls for Thread Management
	     \item VM: dealt with Swapping
	    \end{enumerate}
\end{enumerate}
